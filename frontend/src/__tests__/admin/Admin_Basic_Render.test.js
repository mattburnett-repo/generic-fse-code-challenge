...
//     verify: jest.fn().mockReturnValue({ username: 'qwer' }), // overwrite verify
//     }));
...
describe('Admin component basic render / nav tests', () => {
    ...
    it('it should click to and render the Edit Users panel, then return to Admin panel', () => {
        ...
        // generate a jwt and add it to auth header
        // include auth header in render / request
        //      I have no idea how to do this, or if it's even the right thing to do.
