                ...
                <div className="container mx-auto px-4  ">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="hidden sm:flex sm:items-center ">
                            ...
                            <h3 className="text-1xl text-center m-4 text-sky-700">flash messaging goes here</h3>        
                            </div>
                        </div>

                        <div className="hidden sm:flex sm:items-center">
                            <button type="button" className="bg-blue-200 hover:bg-blue-400 active:bg-blue-600 px-4" onClick={handleLogoutClick}>Log Out</button>
                        </div>
